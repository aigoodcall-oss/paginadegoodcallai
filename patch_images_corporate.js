...
content = content.replace(/wsp_ai_serious\.png/g, 'wsp_ai_corporate.png');
content = content.replace(/voice_ai_serious\.png/g, 'voice_ai_corporate.png');
content = content.replace(/web_dev_serious\.png/g, 'web_dev_corporate.png');

if (!content.includes('wsp-widget')) {
  const widgetHtml = `
<!-- WHATSAPP WIDGET -->
...
console.log("Images swapped and WhatsApp widget restored!");
